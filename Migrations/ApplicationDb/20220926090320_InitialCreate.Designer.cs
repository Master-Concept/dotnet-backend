...
namespace TodoApi.Migrations.ApplicationDb
{
    ...
    [Migration("20220926090320_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TodoApi.Models.Movie", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("c037fa15-d0cd-4a97-baab-e40b5abb5bc6"),
                            ...
                            SuperheroId = new Guid("0cd755c2-92a3-4bf9-85ea-3e3c5884c2c4"),
                            Title = "Batman Begins"
                        },
                        new
                        {
                            Id = new Guid("25f82591-7246-4b11-b0c0-996cfda33558"),
                        ...
                        new
                        {
                            Id = new Guid("01a8973e-f530-4b4a-be3f-adaf35a8a1ac"),
                        ...
                        new
                        {
                            Id = new Guid("5e3cc4ae-4b7c-4323-a941-f1000855747d"),
                            ...
                            SuperheroId = new Guid("f322abce-f245-403c-8601-11291ad40086"),
                            Title = "Star Wars: Episode IV – A New Hope"
                        },
                        new
                        {
                            Id = new Guid("2e002fba-f6ac-4369-b12a-7c78cdc4807a"),
                        ...
                        new
                        {
                            Id = new Guid("09b87dab-3874-4d2c-bba1-f5edce8205a2"),
                        ...
                        new
                        {
                            Id = new Guid("c7fd67fe-83a7-4f57-8592-e15c15f34074"),
                            ...
                            SuperheroId = new Guid("c3e04685-8a02-4aed-8f02-4ff3ee4e1301"),
                            Title = "Black Widow"
                        });
                });

            modelBuilder.Entity("TodoApi.Models.Superhero", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("0cd755c2-92a3-4bf9-85ea-3e3c5884c2c4"),
                        ...
                        new
                        {
                            Id = new Guid("f322abce-f245-403c-8601-11291ad40086"),
                        ...
                        new
                        {
                            Id = new Guid("c3e04685-8a02-4aed-8f02-4ff3ee4e1301"),
            ...
            modelBuilder.Entity("TodoApi.Models.Superpower", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("776f6296-d319-4eca-ad61-cff044adcdbd"),
                        ...
                        new
                        {
                            Id = new Guid("d6312895-b8c0-4073-acf9-dfc80f70cb2b"),
                        ...
                        new
                        {
                            Id = new Guid("305129a0-6b4c-44aa-af2e-d7f0d668a79e"),
                        ...
                        new
                        {
                            Id = new Guid("b1d26e45-65e4-4ef2-8a00-04324e357951"),
                        ...
                        new
                        {
                            Id = new Guid("1ba52bac-431c-4672-960b-2d1c22578fcb"),
                        ...
                        new
                        {
                            Id = new Guid("6a2ff347-c0ce-4a34-a2c0-1d9587d428c0"),
                        ...
                        new
                        {
                            Id = new Guid("04a4ca4b-e361-4a60-b6a1-19c24a193aab"),
            ...
            modelBuilder.Entity("TodoApi.Models.Movie", b =>
                {
                    b.HasOne("TodoApi.Models.Superhero", "Superhero")
                        .WithMany("Movies")
